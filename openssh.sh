...
state=Semarang
locality=JawaTengah
organization=CyberTeam
organizationalunit=CyberTeam
commonname=optimalkan.id
email=admin@optimalkan.id
# go to root
cd
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/paylimit/master/main/squid3.conf"
...
#wget https://raw.githubusercontent.com/paylimit/master/main/badudp2.sh
#chmod +x badudp2.sh
#bash badudp2.sh
...
# Custom Banner SSH
wget -O /etc/issue.net "https://raw.githubusercontent.com/paylimit/master/main/banner-custom.conf"
...
# download script
cd /usr/bin
wget -O menu "https://raw.githubusercontent.com/paylimit/master/main/menu.sh"
wget -O usernew "https://raw.githubusercontent.com/paylimit/master/main/usernew.sh"
wget -O trial "https://raw.githubusercontent.com/paylimit/master/main/trial.sh"
wget -O hapus "https://raw.githubusercontent.com/paylimit/master/main/hapus.sh"
wget -O cek "https://raw.githubusercontent.com/paylimit/master/main/user-login.sh"
wget -O member "https://raw.githubusercontent.com/paylimit/master/main/user-list.sh"
wget -O jurus69 "https://raw.githubusercontent.com/paylimit/master/main/restart.sh"
wget -O speedtest "https://raw.githubusercontent.com/paylimit/master/main/speedtest_cli.py"
wget -O info "https://raw.githubusercontent.com/paylimit/master/main/info.sh"
wget -O about "https://raw.githubusercontent.com/paylimit/master/main/about.sh"
wget -O delete "https://raw.githubusercontent.com/paylimit/master/main/delete.sh"
...
echo "Dropbear  : 443,80,109"  | tee -a log-install.txt
...
wget -O /usr/local/bin/userdelexpired "https://raw.githubusercontent.com/paylimit/master/main/userdelexpired" && chmod +x /usr/local/bin/userdelexpired
